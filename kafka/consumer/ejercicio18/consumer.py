...
zones = ['Norte', 'Sur', 'Este']

# Creación de la figura de Plotly con una fila y una columna por zona
fig = make_subplots(rows=1, cols=3, subplot_titles=zones)
...
html_file = '/consumer/ejercicio18/temperature_by_zone.html'
